def vector_projection_fn(pygame, screen, COLOR_PALETTE, CVector2d,
    ...
    pygame.draw.line(screen, COLOR_PALETTE['gray'], pos + projx_a_on_b,
                     mouse_position, 3)
    pygame.draw.line(screen, COLOR_PALETTE['gray'], pos + projy_a_on_b,
                     mouse_position, 3)
